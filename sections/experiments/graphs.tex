...
\addplot coordinates{(0,ItemSplitting) (0.375,CAMF) (0,CAMF-CI) (0,DW+kNN) (0.441,NMF) (0.476,Random) (0.540,SVD++) (0.508,SVD)};
\legend{CoMoDa, Yahoo, MovieLens}
\end{axis}
\end{tikzpicture}
\end{figure}
...
\addplot coordinates{(0,ItemSplitting) (0.683,CAMF) (0.670,CAMF-CI) (0,DW+kNN) (0.650,NMF) (0.469,Random) (0.673,SVD++) (0.673,SVD)};
\legend{CoMoDa, Yahoo, MovieLens}
\end{axis}
\end{tikzpicture}
\end{figure}