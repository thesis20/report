...
Most of the examined papers perform offline evaluation, mainly employing recall and NDCG@N to evaluate the algorithms, and cross-validate on the sets when testing.
