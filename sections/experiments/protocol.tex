...
Most of the datasets provide contextual information, or allow for context to be inferred through the timestamps provided.
The exception is the Yahoo! dataset where we experiment with using user information such as \textit{age group} and \textit{gender} as context.
