...
\autoref{fig:comoda-rmse}, \autoref{fig:yahoo-rmse} and \autoref{fig:movielens-rmse} visualize RMSE and MAE for LDOS-CoMoDa, Yahoo! and MovieLens respectively, whereas \autoref{fig:comoda-mae}, \autoref{fig:yahoo-mae} and \autoref{fig:movielens-mae} visualize MAE for the respective datasets.\\
For the LDOS-CoMoDa dataset, the metrics Precision@10, Recall@10, NDCG@10, MAP@10 and F1@10 are visualized in respectively \autoref{fig:comoda-precision}, \autoref{fig:comoda-recall}, \autoref{fig:comoda-ndcg}, \autoref{fig:comoda-map} and \autoref{fig:comoda-f1}.
Likewise, for the MovieLens 100K datasets the metrics are visualized in \autoref{fig:movielens-precision}, \autoref{fig:movielens-recall}, \autoref{fig:movielens-ndcg}, \autoref{fig:movielens-map} and \autoref{fig:movielens-f1}.
The same metrics for Yahoo! Movies are visualized in \autoref{fig:yahoo-precision}, \autoref{fig:yahoo-recall}, \autoref{fig:yahoo-ndcg}, \autoref{fig:yahoo-map} and \autoref{fig:yahoo-f1}.
Finally, the Frappé dataset visualizes results on Precision@10, Recall@10, NDCG@10, MAP@10 and F1@10 on respectively \autoref{fig:frappe-precision}, \autoref{fig:frappe-recall}, \autoref{fig:frappe-ndcg}, \autoref{fig:frappe-map} and \autoref{fig:frappe-f1}.
