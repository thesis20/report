...
As mentioned, we are looking at two of these context variables, which are the \textit{dominantEmo} and the \textit{physical} attributes as these are the most influential.
...
It should, however, be noted that these methods were created with a focus on MAE and RMSE scores, and not precision or recall.
