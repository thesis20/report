...
It is important to note that the graph-based methods focus on top-$N$ recommendations, to which they utilize implicit ratings.
This may give them a disadvantage compared to rating prediction methods, since these use explicit ratings meaning that have more available information that can help them order the recommendations for the user.
\\
