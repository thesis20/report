...
%-> when are they used (optimizing?)
%-> are they actually useful in a real-world application?
...
\subsubsection{Inferred information on the datasets} % TODO
% Discretized data: Did we split it optimally? (Weekend or not, vs day of week) (other intervals for time)
% måske samme som contextual discretization subsub section
...
% TODO discuss om det kan gøres anderledes i guess
% TODO: Skal vi skrive noget om hvordan vi har kørt movielens med både context og side information hver for sig?

\subsubsection{How do the context-aware methods utilize context?} % TODO
...
\subsubsection{Did context and side information matter?} % TODO
...
\subsubsection{Contextual discretization} % TODO
...
\subsubsection{The performance of graph based methods} % TODO
