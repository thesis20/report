...
The results can be seen in %Ref til table i appendix?. 
...
Instead we suspect, as mentioned earlier, that the main reason they perform poorly is because they do not utilize the ratings like the other methods do, but are rather used for datasets with implicit ratings.