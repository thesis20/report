...
\autoref{tab:paperdatasets2} shows the metrics used for evaluation for the different examined papers, as well as the percentage of papers employing that metric for evaluation.
...
Generally, the papers examined in \autoref{tab:paperdatasets2} employ cross validation across a number of folds, across a range of 3-10 folds.
\todo{Særning om at de evaluerer vha crossfold vilidation, giv en range på størrelsen af deres forskellige sæt.}
...
\begin{table}[]
    ...
    \hline
       ...
       \cite{GameTheoretic}  & \begin{tabular}[c]{@{}l@{}}RMSE, MAE, Recall@N, \\ DCG@N\end{tabular}                   & \begin{tabular}[c]{@{}l@{}}50\% training, 30\% testing,\\ 20\% validation, averaged results\end{tabular}                     \\ \hline
       ...
       \cite{SinghUserItem}  & MAE, Coverage                                                                           & 50\% training, 20\% test                                                                                                     \\ \hline
...
\begin{sidewaystable}[]
    ...
    \hline
       & \multicolumn{1}{l|}{LDOS-CoMoDa} & \multicolumn{1}{l|}{MovieLens} & \multicolumn{1}{l|}{Frappe} & \multicolumn{1}{l|}{InCarMusic} & DePaul                 & Evaluation Metrics                                                                      & Evaluation Protocol                                                                                                          \\ \hline
       \cite{IoTLargeScale}  & x                                & x                              & x                           & x                               &                        & \begin{tabular}[c]{@{}l@{}}RMSE, MSE, MAE, Precision, \\ Recall, F-measure\end{tabular} & 5-fold, 4 training and 1 test                                                                                                \\ \hline
       \cite{GameTheoretic}  & x                                &                                &                             & x                               &                        & \begin{tabular}[c]{@{}l@{}}RMSE, MAE, Recall@N, \\ DCG@N\end{tabular}                   & \begin{tabular}[c]{@{}l@{}}50\% training, 30\% testing,\\ 20\% validation, averaged results\end{tabular}                     \\ \hline
       \cite{Soft-RoughArticle}  & x                                &                                &                             &                                 &                        & Recall@N, DCG@N                                                                         & \begin{tabular}[c]{@{}l@{}}20\% training,, 30\% testing, \\ 50\% test and train from learning\end{tabular}                   \\ \hline
       \cite{HierarchicalLatentPaper}  & x                                &                                & x                           &                                 &                        & RMSE, MAE                                                                               & \begin{tabular}[c]{@{}l@{}}10 subsets, each subset split into \\ 80\% training, 10\% testing,\\ 10\% validation\end{tabular} \\ \hline
       \cite{AdaptEmotionalReactions}  & x                                &                                &                             &                                 &                        & MAE, NDCG@N, Precision                                                                  & 5-fold, 4 training and 1 test                                                                                                \\ \hline
       \cite{SinghUserItem}  & x                                &                                &                             &                                 &                        & MAE, Coverage                                                                           & 50\% training, 20\% test                                                                                                     \\ \hline
       \cite{CorrelationPreFiltering}   & x                                &                                &                             &                                 &                        & MAE, RMSE                                                                               & 5-fold                                                                                                                       \\ \hline
       \cite{ParticleSwarmPaper}  & x                                &                                &                             & x                               &                        & \begin{tabular}[c]{@{}l@{}}MAE, RMSE, Precision, Recall, \\ F1-measure\end{tabular}     & 3-fold, 2 training and 1 test                                                                                                \\ \hline
       \cite{ContextualInfluencePaper}  & x                                &                                &                             &                                 &                        & RMSE                                                                                    & \begin{tabular}[c]{@{}l@{}}2:1 proportion of training to test,\\ averaged over 20 iterations\end{tabular}                    \\ \hline
       \cite{AuxiliaryInformationPaper} & x                                &                                &                             &                                 &                        & RMSE, MAE                                                                               & Unspecified                                                                                                                  \\ \hline
       \cite{ImprovedSimilarityPaper} & \multicolumn{1}{l|}{}            & x                              &                             & x                               &                        & \begin{tabular}[c]{@{}l@{}}RMSE, MAE, Precision@N, \\ Recall@N, F1-measure\end{tabular} & \begin{tabular}[c]{@{}l@{}}3 random partitions, 2 for training\\ and 1 for testing, \\average over 5 iterations\end{tabular}   \\ \hline
       \cite{GraphBasedCollaborativePaper} & \multicolumn{1}{l|}{}            & x                              &                             & x                               & \multicolumn{1}{c|}{x} & Precision@N, MAP@N                                                                      & 10-fold, average over 10 iterations                                                                                          \\ \hline
       \cite{ArtificalBeePaper} & \multicolumn{1}{l|}{}            & x                              &                             &                                 &                        & \begin{tabular}[c]{@{}l@{}}MAE, Precision@N, \\ Recall@N,\end{tabular}                  & Unspecified                                                                                                                  \\ \hline
       \cite{StackedRecurrentNeuralPaper} & \multicolumn{1}{l|}{}            & x                              &                             & \multicolumn{1}{l|}{}           &                        & \begin{tabular}[c]{@{}l@{}}Recall@N, Precision@N, \\ F1@N, NDCG\end{tabular}            & \begin{tabular}[c]{@{}l@{}}First 80\% of each user's history\\ for training, remaining 20\% for test\end{tabular}           \\ \hline
    \end{tabular}
    \caption{Context-Aware papers and the datasets used.}
    \label{tab:paperdatasets3}
    \end{sidewaystable}
