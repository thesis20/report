...
\begin{sidewaystable}[]
    ...
    \hline
       & \multicolumn{1}{l|}{LDOS-CoMoDa} & \multicolumn{1}{l|}{MovieLens} & \multicolumn{1}{l|}{Frappe} & \multicolumn{1}{l|}{InCarMusic} & DePaul                 & Evaluation Metrics                           \\ \hline
       \cite{IoTLargeScale}  & x                                & x                              & x                           & x                               &                        & RMSE, MSE, MAE, Precision, Recall, F-measure \\ \hline
       \cite{GameTheoretic}  & x                                &                                &                             & x                               &                        & RMSE, MAE, Recall@N, DCG@N                   \\ \hline
       \cite{Soft-RoughArticle}  & x                                &                                &                             &                                 &                        & Recall@N, DCG@N                              \\ \hline
       \cite{HierarchicalLatentPaper}  & x                                &                                & x                           &                                 &                        & RMSE, MAE                                    \\ \hline
       \cite{AdaptEmotionalReactions}  & x                                &                                &                             &                                 &                        & MAE, NDCG@N, Precision                       \\ \hline
       \cite{SinghUserItem}  & x                                &                                &                             &                                 &                        & MAE, Coverage                                \\ \hline
       \cite{CorrelationPreFiltering}  & x                                &                                &                             &                                 &                        & MAE, RMSE                                    \\ \hline
       \cite{ParticleSwarmPaper}  & x                                &                                &                             & x                               &                        & MAE, RMSE, Precision, Recall, F1-measure     \\ \hline
       \cite{ContextualInfluencePaper}  & x                                &                                &                             &                                 &                        & RMSE                                         \\ \hline
       \cite{AuxiliaryInformationPaper} & x                                &                                &                             &                                 &                        & RMSE, MAE                                    \\ \hline
       \cite{ImprovedSimilarityPaper} & \multicolumn{1}{l|}{}            & x                              &                             & x                               &                        & RMSE, MAE, Precision@N, Recall@N, F1-measure \\ \hline
       \cite{GraphBasedCollaborativePaper} & \multicolumn{1}{l|}{}            & x                              &                             & x                               & \multicolumn{1}{c|}{x} & Precision@N, MAP@N                           \\ \hline
       \cite{ArtificalBeePaper} & \multicolumn{1}{l|}{}            & x                              &                             &                                 &                        & MAE, Precision@N, Recall@N,                  \\ \hline
       \cite{StackedRecurrentNeuralPaper} & \multicolumn{1}{l|}{}            & x                              &                             & \multicolumn{1}{l|}{}           &                        & Recall@N, Precision@N, F1@N, NDCG            \\ \hline
    \end{tabular}
    \caption{Context-Aware papers and the datasets used.}
    \label{tab:paperdatasets}
\end{sidewaystable}
