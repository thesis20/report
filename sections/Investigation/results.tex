...
To calculate MAP, \textit{Average Precision} (AP) must first be calculated.
...
\end{equation}
Once AP is calculated for a single user $u$, MAP@N for a recommender system is defined through \autoref{eq:map}, where $U$ is the set of all users: 
\begin{equation}
    \label{eq:map}
