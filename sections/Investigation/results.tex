...
Frappé collected implicit data on the following context dimensions: use count, time of day, weekday, whether or not it is weekend, home or at work, weather, country, city, application package, category, number of downloads, developer, icon, language, description, name, price, rating and short description. 
