...
Development of a predictive model% insert your subtitle here
	...
	\begin{minipage}{0.9\textwidth}
        ...
        \centering
        {\Large
Daniel Moesgaard Andersen, Rasmus Bundgaard Eduardsen, Andreas Stenshøj% insert names separated by comma
        }
    \end{minipage}
    }
    ...
    \begin{minipage}{0.9\textwidth}
        ...
        \centering
        {\large
        Software, mi902e20, 2021-01% insert name of study, group number, year-month
        } 
    \end{minipage}
    }
