...
For example, aggregation at the first layer capture the direction interaction between users and items, the second layer capture users that have an overlap in their interactions and so on.
